...
export default function App() {
  ...
  const tarjetaDeItemDeCompra = ({ item }: { item: Item }) => (
    <Pressable
  ...
  return (
    ...
    <TituloDeLaPagina/>
     <FormularioParaAgregarUnNuevoItem
      ...
      alAgregarUnItem={setText}></FormularioParaAgregarUnNuevoItem>
...
const ListaDeCompras = ({
  ...
  <FlatList
        ...
        renderItem={tarjetaDeItemDeCompra}
        ListEmptyComponent={
...
const FormularioParaAgregarUnNuevoItem=({
  texto, 
  AlIntroducirTexto,
  alAgregarUnItem
  }:{
